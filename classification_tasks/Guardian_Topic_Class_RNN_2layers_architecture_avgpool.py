...
parser.add_argument('--LSTM1_dims', type=int, nargs='+', default=[64, 64])
parser.add_argument('--LSTM2_dims', type=int, nargs='+', default=[64, 64])
parser.add_argument('--DENSE_dims', type=int, nargs='*', default=[64])
