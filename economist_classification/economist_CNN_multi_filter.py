...
concatenated_tensor = Concatenate(axis=1)([pooled_conv_0, pooled_conv_1, pooled_conv_2, pooled_conv_3, pooled_conv_4 ])
flatten = Flatten()(concatenated_tensor)
dropout = Dropout(drop)(flatten)
dense1 = Dense(128, activation = 'relu')(dropout)
output = Dense(num_labels,kernel_regularizer=regularizers.l2(0.001),activity_regularizer=regularizers.l1(0.001), activation='softmax')(dense1)
