...
parser.add_argument('-i', '--input_dir', type=str, help='directory containing data', default='../NewsMining/processed_data/Guardian_10k/')
...
parser.add_argument('-w', '--max_words', type=int, help='max_words in a sentence', default=670)
